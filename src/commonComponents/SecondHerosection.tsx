...
import secondHeroUnderline from "../assets/herosectionUnderlineVector.png";
...
class SecondHerosection extends Component<Props>{
            ...
            <Box className={`${classes.herosection} ${this.props.herosectionBody}`}>
                <Box className={classes.herosectionUpperBody}>
                    <Box className={classes.herosectionContent}>
                        ...
                        <Box>
                            <img src={secondHeroUnderline} alt="secondUnderline" className={classes.herosectionUnderline}/>
                        </Box>
...
export default withStyles(style)(SecondHerosection);