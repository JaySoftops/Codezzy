...
import clipPathImage from "../assets/Clip path group.png";
import RegistrationForm from "../commonComponents/RegistrationForm";
interface Props {
  classes: any;
}
class ContactRegForm extends Component<Props> {
  renderFormContent = (classes: any) => {
    return (
      <Box className={classes.contentBox}>
        <Box className={classes.contentHeading}>
          Create your Account Get free access to{" "}
        ...
        <Box className={classes.contentFlex}>
          ...
          <Box className={classes.contentParagraph}>
...
export default withStyles(style)(ContactRegForm);